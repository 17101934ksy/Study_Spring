...
public class QCategory extends EntityPathBase<Category> {
    ...
    public final ListPath<jpabook.jpashop.domain.items.Item, jpabook.jpashop.domain.items.QItem> items = this.<jpabook.jpashop.domain.items.Item, jpabook.jpashop.domain.items.QItem>createList("items", jpabook.jpashop.domain.items.Item.class, jpabook.jpashop.domain.items.QItem.class, PathInits.DIRECT2);
