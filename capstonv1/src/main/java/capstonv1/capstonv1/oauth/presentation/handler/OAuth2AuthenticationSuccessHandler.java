package capstonv1.capstonv1.oauth.presentation.handler;
...
import static capstonv1.capstonv1.oauth.infra.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static capstonv1.capstonv1.oauth.infra.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        // DB 저장
        MemberRefreshToken memberRefreshToken = memberRefreshTokenRepository.findBySocialId(memberInfo.getId());
        if (memberRefreshToken != null) {
            memberRefreshToken.setRefreshToken(refreshToken.getToken());
        } else {
            memberRefreshToken = new MemberRefreshToken(memberInfo.getId(), refreshToken.getToken());
